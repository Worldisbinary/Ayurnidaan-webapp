...
export const GetDoshaOutputSchema = z.object({
    ...
    doshaPercentages: z.object({
        vata: z.number().describe('The percentage of Vata dosha, from 0 to 100.'),
        pitta: z.number().describe('The percentage of Pitta dosha, from 0 to 100.'),
        kapha: z.number().describe('The percentage of Kapha dosha, from 0 to 100.'),
    }).describe('The percentage breakdown of the three doshas. The sum should be close to 100.'),
});
